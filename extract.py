...
def straighten(image):
    ...
    # cv2.imshow('filtered', cv2.resize(filtered, (960, 540)))
    ...
    # cv2.imshow('dilated', cv2.resize(dilated, (960, 540)))
...
def barometer(image):
    ...
    # cv2.imshow('inverted', cv2.resize(inverted, (960, 540)))
...
def start(file_name):
    ...
    # cv2.imshow('straightened', cv2.resize(straightened, (960, 540)))
